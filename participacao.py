...
data_file = Path(__file__).with_name("percentualParticipacaoEncargosDepartamentosCurso_concatenados.xlsx")

if not data_file.exists():
    st.error(
        "Arquivo percentualParticipacaoEncargosDepartamentosCurso_concatenados.xlsx "
